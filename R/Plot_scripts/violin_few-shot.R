...
full_data = read_csv("gpt4_turbo_full_fs_march.csv")
...
names(model.labs) = c("gpt-4-turbo-2024-04-09")
...
png(paste("", "no_Setup_thesis_violin_fewshot_GPT4turbo.png", sep = ""), width = 2500, height = 1142)
p.ordinary.habit +
